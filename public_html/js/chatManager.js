    ...
    if (input && sendBtn) {
        const sendMessage = async () => {
            ...
            if (content) {
                ...
                // Stocker le contenu avant de vider l'input
                const messageToSend = content;
                
                // Vider l'entrée avant d'envoyer
                input.value = '';
                ...
                // Attendre que l'envoi se termine avant de procéder
                ...
                if (success) {
                    ...
                    this.playSound('error');
                    // En cas d'échec, remettre le contenu dans l'input
        ...
        // Utiliser une fonction séparée pour l'événement de clic
        sendBtn.addEventListener('click', (e) => {
            e.preventDefault(); // Empêcher toute action par défaut du bouton
            sendMessage();
        });
