...
class ChatManager {
    ...
    // Initialisation du PushManager avec plus de logs
    console.log('Création du PushNotificationManager...'); // Nouveau log
    this.pushManager = new PushNotificationManager();
    this.pushManager.setSupabase(this.supabase);
    console.log('PushManager créé et Supabase connecté'); // Nouveau log
    ...
    try {
        ...
        // Remplacer ce bloc par l'initialisation du Push Manager
        if ('serviceWorker' in navigator) {
            try {
                await this.pushManager.init();
                const isInitialized = await this.pushManager.init();
                if (isInitialized) {
                    this.notificationsEnabled = this.pushManager.isSubscribed;
